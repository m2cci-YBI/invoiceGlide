...
import { PreviewInvoice } from '../../invoices/invoice-preview/invoice-preview.component';
...
export class SettingsInvoiceTemplateComponent extends SettingsBaseComponent {
  styleKeys = [
  ...
  previewInvoiceData: PreviewInvoice | undefined; // Property to store the generated invoice

  constructor(public override settingsService: SettingsService, toast: ToastService) {
    super(settingsService, toast);
  }

  override openPreview() {
    this.previewInvoiceData = this.generatePreviewInvoice(); // Generate only when opening
    this.showPreview = true;
  }

  generatePreviewInvoice(): PreviewInvoice {
